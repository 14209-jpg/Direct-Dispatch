...
mixin _$Message {
  ...
  String get senderRole =>
      throw _privateConstructorUsedError; // 'customer' | 'admin'
...
class _$MessageImpl implements _Message {
  ...
  @override
  String toString() {
    return 'Message(id: $id, conversationId: $conversationId, senderId: $senderId, senderName: $senderName, senderRole: $senderRole, body: $body, readBy: $readBy, createdAt: $createdAt)';
  }
...
abstract class _Message implements Message {
  ...
  @override
  String get senderRole; // 'customer' | 'admin'
  @override
  String get body;
  @override
  List<String> get readBy;
